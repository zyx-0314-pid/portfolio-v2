(() => {
    ...
    const initializeSectionNavigator = () => {
        ...
        const getSectionIcon = (label) => {
            ...
            const iconRules = [
                [/^teaching standard$/, 'fa-chalkboard-user'],
                [/^template scaffold$/, 'fa-pen-ruler'],
                [/^separation of concerns$/, 'fa-code'],
                [/^page workflow$/, 'fa-arrows-spin'],
                [/^responsibility decisions$/, 'fa-user-tie'],
                [/^collaboration$/, 'fa-users'],
                [/^organization problem$/, 'fa-triangle-exclamation'],
                [/^public deployment$/, 'fa-server'],
                [/^architecture progression$/, 'fa-diagram-project'],
                [/^structure constraint$/, 'fa-border-all'],
                [/^starting small$/, 'fa-seedling'],
                [/^combat math$/, 'fa-calculator'],
                [/^characters$/, 'fa-user-group'],
                [/^status effects$/, 'fa-flask-vial'],
                [/^playtesting$/, 'fa-gamepad'],
                [/^randomness$/, 'fa-dice'],
                [/^enemies$/, 'fa-skull'],
                [/^scope$/, 'fa-minimize'],
                [/^looking back$/, 'fa-clock-rotate-left'],
                [/^modern reflection$/, 'fa-lightbulb'],
                [/^lesson$/, 'fa-scale-balanced'],
                [/^why$/, 'fa-circle-question'],
                [/^environment$/, 'fa-cubes'],
                [/^reproducible setup$/, 'fa-box-open'],
                [/^different computers$/, 'fa-laptop-file'],
                [/^database evolution$/, 'fa-code-branch'],
                [/^configuration$/, 'fa-sliders'],
                [/^database choice$/, 'fa-scale-balanced'],
                [/^database mistakes$/, 'fa-circle-xmark'],
                [/^two databases$/, 'fa-code-compare'],
                [/^setup overhead$/, 'fa-hourglass-half'],
                [/^deployment readiness$/, 'fa-rocket'],
                [/^engineering discipline$/, 'fa-list-check'],
                ...
                [/authors?|institutions?|collaboration|co-authors?/, 'fa-users'],
                [/methodology|method|approach|protocol/, 'fa-flask'],
                ...
                [/testing|verification|verified|validation|evaluation|quality|functional|api|end-to-end|performance|seo/, 'fa-vial-circle-check'],
                ...
                [/citation|publication|reference|bibliography/, 'fa-quote-left'],
                [/destinations?|external links?|external/, 'fa-arrow-up-right-from-square'],
                [/documentation|manual|knowledge|records|evidence|links|credentials|related/, 'fa-file-lines'],
                [/findings?|results?|outcomes?|insights?/, 'fa-square-check'],
